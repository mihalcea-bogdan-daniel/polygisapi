...
router.route("/:uuid").post((req, res) => {
    ...
    `INSERT INTO search_history (judet, localitate, numar_cadastral, polygon_numar_cadastral, uuid, data) VALUES (
        '${req.query.judet}', 
    ...
    console.log(`( ${req.query.judet},  ${req.query.localitate},  POLYGON(${req.query.polygon}),  ${req.params.uuid} )`);
